...
htmlString += util.genTag(templateObject_1 || (templateObject_1 = __makeTemplateObject(["title", ""], ["title", ""])), name);
...
htmlString += util.genTag(templateObject_5 || (templateObject_5 = __makeTemplateObject(["h1", ""], ["h1", ""])), name);
htmlString += util.genTag(templateObject_6 || (templateObject_6 = __makeTemplateObject(["p", ""], ["p", ""])), subtitle);
